...
//           <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">Student Login</h1>
...
//             Don't have an account? <Link to="/student-signup" className="text-primary-600 font-semibold">Sign up here</Link>
//           </div>
//         </div>
//       </div>
//     </div>
